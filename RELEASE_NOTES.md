...
- **不具合解消**
  - レビュー履歴が大量にある場合にプロジェクト削除をするとDynamoDBにデータが残ってしまう不具合を解消

---
### Version 1.3.9 - 2026/05/24
**その他**

- **モジュールアップデート**
  - 脆弱性対応として一部フロントエンドのパッケージを更新

---
### Version 1.3.8 - 2026/04/27
**機能改善**
...
---
### Version 1.3.7 - 2026/04/26
**機能追加**

- **AIコスト管理機能**
  - AIコスト管理機能を追加
    - レビュー一覧にAIコスト表示機能、AIコスト料金設定機能などを追加


---
### Version 1.3.6 - 2026/04/23
**その他**
...
- **不具合解消**
  - RAG利用かつSonnet4.5以上の場合に発生する不具合を解消


---
### Version 1.3.4 - 2026/04/18
**機能の改善**

- **機能改修**
  - PDFの場合にClaude PDFモードで動作するように改善
  - PDFのレビュー後修正確認の精度向上を実施
...
- **不具合解消**
  - 大量レコードがある場合、レビュー情報（個別）タブに正しくレビュー記録が表示されない不具合を解消


---
### Version 1.3.2 - 2025/11/12
**不具合の改善**

- **不具合解消**
  - 有料ライセンス登録状態の場合、次回更新日の数日前にプラン表示がおかしくなる不具合を解消


---
### Version 1.3.1 - 2025/10/15
**機能の改善**

- **機能改修**
  - ダッシュボードに表示されるレビューの登録時間をレビュー情報（個別）タブと統一


---
### Version 1.3.0 - 2025/10/11
**機能追加**

- **ユーザ管理機能**
  - マルチユーザ管理機能を追加
    - ロール制御機能、ログイン管理機能などを追加
